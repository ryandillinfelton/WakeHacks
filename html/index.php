...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
		<a href="#home" class="w3-bar-item w3-button"><img src="./images/longlogo.png" height="25px;" width="100px;"></a>
    <!-- <a href="#home" class="w3-bar-item w3-button"><b>Food</b>Me</a>)>
...
<!-- Header -->
<header class="w3-display-container w3-content w3-wide" style="max-width:100%; height:780px; background-color:#020513;" id="home">
  <link rel="shortcut icon" src="./images/favicon.ico">
  <img class="w3-image w3-display-middle" src="./images/homepageCar.png" alt="Architecture" width="70%" height="90%", style="padding-top: 1px; padding-bottom: 150px; ">
  <div class="w3-display-bottommiddle" style="padding-top: 250px; padding-bottom: 50px; ">
    <p class="w3-hide-medium w3-text-white w3-large">Our mission is to help those in need of a nicer meal. Our distributed approach allows those in need to recieve help more quickly and without intervention. Please consider Volunteering some of your time to help another person.</p>
  </div>
</header>
...
<!--<div class="card" id="map">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12889.143924008979!2d-80.2763425!3d36.1352495!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9e805d290cfd29f0!2sWake+Forest+University!5e0!3m2!1sen!2sus!4v1521320099965" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
      </div>-->
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBy0vr7HY_fpBDSwBnG1rW1Ak_PIPfHFwg&callback=myMap"></script>
<!--
